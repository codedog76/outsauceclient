 ...
 */
public class JobOutboxFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, JobAdapter.clickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_job_outbox, container, false);
        ...
        ((MainActivity) getActivity()).setJobOutboxFragmentListener(new MainActivity.JobOutboxFragmentListener() {
            @Override
